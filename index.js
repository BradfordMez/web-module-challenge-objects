...
export const burger = {
  ...
  price: 18, 
  category: "Lunch", 
  discount: function(role){return (role === 'teacher' || role === 'student' )? this.price * 0.75 : this.price * 0.9}
}
...
*/
reviews.push({name: "Ronald", rating: 2, feedback:"Eh, it's aight I suppose."})
...
function getReviewByIndex(reviews, i=0) {
